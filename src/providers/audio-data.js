...
var AudioData = /** @class */ (function () {
    function AudioData(http, user, authService) {
        this.http = http;
        this.user = user;
    ...
    AudioData.prototype.load = function () {
        ...
        var url = this.authService.apiUrl + 'audioBooks';
        if (this.data) {
            // already loaded data
    ...
    AudioData.prototype.processData = function (data) {
    ...
    AudioData.prototype.getTimeline = function (dayIndex, queryText, segment) {
        var _this = this;
    ...
    AudioData.prototype.filterBook = function (book, queryWords, segment) {
