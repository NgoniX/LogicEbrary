...
var SelfAssessmentPage = /** @class */ (function () {
    function SelfAssessmentPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    SelfAssessmentPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad SelfAssessmentPage');
    };
    SelfAssessmentPage = __decorate([
        Component({
